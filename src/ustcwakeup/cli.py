...
def cli_main() -> int:
    ...
    if args["output"] is None:
        with open(
                output.suggest_file_name() + "." + output.get_file_extension(),
                "wb") as file:
...
def get_semester_id(semester_name: str, id_table: dict[str,
                                                       str]) -> str | None:
